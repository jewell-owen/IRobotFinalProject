...
void uart_interrupt_init(void){
  ...
  UART1_CTL_R &= !0x1;  //Setting bit 0 to 0
  ...
  UART1_IM_R |= 0b10000;       //setting bit 4 to 1
  ...
  NVIC_EN0_R |= 0b1000000;      //bit 6 to 1
...
char uart_receive_nonblocking(void){
    char data = 0;
    if (!(UART1_FR_R & UART_FR_RXFE)) data = (char) (UART1_DR_R & 0xFF);
